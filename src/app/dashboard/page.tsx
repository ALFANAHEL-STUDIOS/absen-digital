          ...
          opacity: 0
              ...
              <div className="text-center mb-6" data-unique-id="c7178ff8-72c5-4aaf-816f-64760916c722" data-file-name="app/dashboard/page.tsx">
                ...
                <p className="text-gray-700 text-sm sm:text-base" data-unique-id="75a424d8-d13a-4ab8-8617-639a152d643b" data-file-name="app/dashboard/page.tsx"><span className="editable-text" data-unique-id="dce659af-01ac-4e5f-a15b-d08b69ef6687" data-file-name="app/dashboard/page.tsx">
                  Jika anda pertama kali login ke Aplikasi ABSENSI DIGITAL, jangan lupa untuk dapat menggunakan aplikasi ini, jika adan Admin Sekolah silahkan lengkapi </span>                
                  <span className="font-bold" data-unique-id="a653f151-b5c0-497b-8b52-512420ee7dc1" data-file-name="app/dashboard/page.tsx"><span className="editable-text" data-unique-id="42cb4d7e-5f70-4ba3-a497-f853503ff3b3" data-file-name="app/dashboard/page.tsx">Profil Sekolah</span>
                  <span className="editable-text" data-unique-id="1ba3961d-5e9c-468f-9197-f7404dcd5ca2" data-file-name="app/dashboard/page.tsx"> 
                    
                   , jika anda Guru silahkan lengkapi 
                    <span className="font-bold" data-unique-id="a653f151-b5c0-497b-8b52-512420ee7dc1" data-file-name="app/dashboard/page.tsx"><span className="editable-text" data-unique-id="42cb4d7e-5f70-4ba3-a497-f853503ff3b3" data-file-name="app/dashboard/page.tsx">Profil Pengguna</span>
                    anda dengan cara mengakses Menu yang berada di pojok kanan atas.
                </span></p>
              </div>
