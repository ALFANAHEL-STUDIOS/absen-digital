                ...
                <div className="p-4">
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      <span className="inline-block px-1.5 py-0.5 text-xs bg-green-100 text-blue-700 rounded">
                        Kelas {student.class}
                      </span>
                      <span className="inline-block px-1.5 py-0.5 text-xs bg-blue-100 text-green-700 rounded ml-2">
